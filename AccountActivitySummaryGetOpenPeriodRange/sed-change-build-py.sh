...
printf "\nsed-AccountActivitySummaryGetOpenPeriodRange build: $build" 
printf "\nsed-AccountActivitySummaryGetOpenPeriodRange mysql_host: $mysql_host" 
printf "\nsed-AccountActivitySummaryGetOpenPeriodRange mysql_port: $mysql_port" 
printf "\nsed-AccountActivitySummaryGetOpenPeriodRange azure_dw: $azure_dw" 
printf "\nsed-AccountActivitySummaryGetOpenPeriodRange file: $file" 
