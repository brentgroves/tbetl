...
printf "\nsed-AccountPeriodBalanceRecreateOpenPeriodRange build: $build" 
printf "\nsed-AccountPeriodBalanceRecreateOpenPeriodRange mysql_host: $mysql_host" 
printf "\nsed-AccountPeriodBalanceRecreateOpenPeriodRange mysql_port: $mysql_port" 
printf "\nsed-AccountPeriodBalanceRecreateOpenPeriodRange azure_dw: $azure_dw" 
printf "\nsed-AccountPeriodBalanceRecreateOpenPeriodRange file: $file" 
