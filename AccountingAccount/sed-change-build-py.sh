...
printf "\nsed-AccountingAccount build: $build" 
printf "\nsed-AccountingAccount mysql_host: $mysql_host" 
printf "\nsed-AccountingAccount mysql_port: $mysql_port" 
printf "\nsed-AccountingAccount azure_dw: $azure_dw" 
printf "\nsed-AccountingAccount file: $file" 
