...
printf "\nsed-AccountingBalanceAppendPeriodRange build: $build" 
printf "\nsed-AccountingBalanceAppendPeriodRange mysql_host: $mysql_host" 
printf "\nsed-AccountingBalanceAppendPeriodRange mysql_port: $mysql_port" 
printf "\nsed-AccountingBalanceAppendPeriodRange azure_dw: $azure_dw" 
printf "\nsed-AccountingBalanceAppendPeriodRange file: $file" 
