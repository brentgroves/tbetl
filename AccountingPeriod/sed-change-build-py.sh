...
printf "\nsed-AccountingPeriod build: $build" 
printf "\nsed-AccountingPeriod mysql_host: $mysql_host" 
printf "\nsed-AccountingPeriod mysql_port: $mysql_port" 
printf "\nsed-AccountingPeriod azure_dw: $azure_dw" 
printf "\nsed-AccountingPeriod file: $file" 
