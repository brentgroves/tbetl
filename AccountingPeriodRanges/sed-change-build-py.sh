...
printf "\nsed-AccountingPeriodRanges build: $build" 
printf "\nsed-AccountingPeriodRanges mysql_host: $mysql_host" 
printf "\nsed-AccountingPeriodRanges mysql_port: $mysql_port" 
printf "\nsed-AccountingPeriodRanges azure_dw: $azure_dw" 
printf "\nsed-AccountingPeriodRanges file: $file" 
