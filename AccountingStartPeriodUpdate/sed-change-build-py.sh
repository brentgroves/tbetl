...
printf "\nsed-AccountingStartPeriodUpdate build: $build" 
printf "\nsed-AccountingStartPeriodUpdate mysql_host: $mysql_host" 
printf "\nsed-AccountingStartPeriodUpdate mysql_port: $mysql_port" 
printf "\nsed-AccountingStartPeriodUpdate azure_dw: $azure_dw" 
printf "\nsed-AccountingStartPeriodUpdate file: $file" 
