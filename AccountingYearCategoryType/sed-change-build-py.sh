...
printf "\nsed-AccountingYearCategoryType build: $build" 
printf "\nsed-AccountingYearCategoryType mysql_host: $mysql_host" 
printf "\nsed-AccountingYearCategoryType mysql_port: $mysql_port" 
printf "\nsed-AccountingYearCategoryType azure_dw: $azure_dw" 
printf "\nsed-AccountingYearCategoryType file: $file" 
