...
# %DEV%azure_dw = '%AZURE_DW%'
  ...
  im2 ='''insert into Plex.trial_balance_multi_level (pcn,period,period_display,category_type,category_name,sub_category_name,account_no,account_name,current_debit_credit,ytd_debit_credit)
