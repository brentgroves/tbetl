...
printf "\nsed-script-end-py build: $build" 
printf "\nsed-script-end-py mysql_host: $mysql_host" 
printf "\nsed-script-end-py mysql_port: $mysql_port" 
printf "\nsed-script-end-py azure_dw: $azure_dw" 
printf "\nsed-script-end-py file: $file" 

if [[ $build == 'dev' ]]
then
  printf '\ndev build'
  sed -e '/%DEV%/s/%DEV%/  /' tmp-script-end.py | \
