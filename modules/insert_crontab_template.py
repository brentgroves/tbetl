...
def insert_crontab(params):
  try:
      print_to_stdout(f"Start of insert_crontab")
      # DEBUG ONLY
      # report_id = 1
      # etl_only = 1
      # parameters = '{"etl_only":0,"report_name":"daily_metrics","email":"bgroves@buschegroup.com","start_period":202201,"end_period":202207}'
      
      %DEV%os.environ['MYSQL_HOST'] = '%MYSQL_HOST%'
      %DEV%os.environ['MYSQL_PORT'] = '%MYSQL_PORT%'
  ...
  # https://www.pythontutorial.net/python-basics/python-read-text-file/
      ...
      sql=f'insert into Report.crontab (params) values(\'{params}\')'
...
if __name__ == '__main__':
  insert_crontab(job_name="trial_balance.open_periods.dm.daily",params='{"etl_only":0,"report_name":"daily_metrics","email":"bgroves@buschegroup.com","start_period":202201,"end_period":202207}')
